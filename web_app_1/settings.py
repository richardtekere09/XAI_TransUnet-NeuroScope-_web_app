"""
Django settings for web_app_1 project.
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'Neuroscope/static')]
...
INSTALLED_APPS = [
    ...
    'NeuroScope.apps.NeuroscopeConfig',
]
...
WSGI_APPLICATION = "web_app_1.wsgi.application"
